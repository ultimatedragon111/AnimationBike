...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        objectAnimator1 = ObjectAnimator.ofFloat(imageView2,"translationY" , 0f , -1650f);
        ...
        relativeLayout1.animate().setDuration(1000).setStartDelay(500).alpha(1.0f).setStartDelay(500).translationX(-275f).translationY(-600f).alpha(0f);
        relativeLayout2.setTranslationY(100f);
        relativeLayout2.animate().setStartDelay(1000).setDuration(1000).translationY(0f).alpha(1f);

        relativeLayout3.setTranslationX(-100);
        relativeLayout3.animate().setStartDelay(1500).alpha(1).rotation(360).translationX(0);
        objectAnimator7= ObjectAnimator.ofFloat(relativeLayout3,"pivotX", 0f,1f);
        objectAnimator7.setStartDelay(1500);
